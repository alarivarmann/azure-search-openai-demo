...
import {Citation} from "../../components/Answer/Citation";
...
export function Component(): JSX.Element {
  ...
  const [answer, setAnswer] = useState<MockChatAppResponse>();
  ...
  const makeApiRequest = async (question: string) => {
    ...
    const response: MockChatAppResponse = {
      ...
      context: {
        ...
        thoughts: [{
          title: "Firstly…",
          description: "This was my initial thought…",
        }]
      },
      session_state: "TEST",
      citations: [
    ...
    <div className={styles.askContainer}>
      <div className={styles.askTopSection}>
        ...
        <div className={styles.askQuestionInput}>
          <p className={styles.asiakkaanTulosyy}>Asiakkaan tulosyy</p>
          <QuestionInput
            placeholder="Kuvaile miksi asiakas tuli vastaanotolle…"
            disabled={isLoading}
      ...
      >
        <TextField
          ...
          onRenderLabel={(props: ITextFieldProps | undefined) => (
            <HelpCallout labelId={promptTemplateId} fieldId={promptTemplateFieldId}
                         helpText={toolTipText.promptTemplate} label={props?.label}/>
          )}
        />
        ...
        <TextField
          ...
          onRenderLabel={(props: ITextFieldProps | undefined) => (
            <HelpCallout labelId={temperatureId} fieldId={temperatureFieldId} helpText={toolTipText.temperature}
                         label={props?.label}/>
          )}
        />
        ...
        <TextField
          ...
          onRenderLabel={(props: ITextFieldProps | undefined) => (
            <HelpCallout labelId={searchScoreId} fieldId={searchScoreFieldId} helpText={toolTipText.searchScore}
                         label={props?.label}/>
          )}
        />
        ...
        {showSemanticRankerOption && (
          <TextField
            ...
            onRenderLabel={(props: ITextFieldProps | undefined) => (
              <HelpCallout labelId={rerankerScoreId} fieldId={rerankerScoreFieldId} helpText={toolTipText.rerankerScore}
                           label={props?.label}/>
            )}
          />
        )}
        ...
        <TextField
          ...
          onRenderLabel={(props: ITextFieldProps | undefined) => (
            <HelpCallout labelId={retrieveCountId} fieldId={retrieveCountFieldId} helpText={toolTipText.retrieveNumber}
                         label={props?.label}/>
          )}
        />
        ...
        <TextField
          ...
          onRenderLabel={(props: ITextFieldProps | undefined) => (
            <HelpCallout labelId={excludeCategoryId} fieldId={excludeCategoryFieldId}
                         helpText={toolTipText.excludeCategory} label={props?.label}/>
          )}
        />
